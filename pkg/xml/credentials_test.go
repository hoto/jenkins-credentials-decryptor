...
var (
	gitlab = &Credential{
		Tags: map[string]string{
			...
			"secretType":  "com.cloudbees.plugins.credentials.impl.UsernamePasswordCredentialsImpl",
		},
	}
	bastion = &Credential{
		Tags: map[string]string{
			...
			"secretType":       "com.cloudbees.jenkins.plugins.sshcredentials.impl.BasicSSHUserPrivateKey",
		},
	}
	exampleCredential = &Credential{
		Tags: map[string]string{
			...
			"secretType": "com.example.ExampleCredential",
		},
	}
)
